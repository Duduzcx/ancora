  ...
  return (
    <div className="flex h-[100dvh] w-full pl-0 md:pl-[calc(16rem+18rem)] relative z-10 bg-transparent transition-all overflow-hidden overscroll-none">
      ...
      <main className="flex-1 flex flex-col h-full relative overflow-hidden overscroll-none">
        ...
        {/* Formulário Flutuante - FIXO NA BASE DO FLEX-COL */}
        <div className="flex-none p-4 pb-safe bg-white/40 backdrop-blur-2xl border-t border-white/20 z-40">
          <div className="max-w-3xl mx-auto">
            <form 
              onSubmit={handleCustomSubmit}
              className="flex items-center bg-white/70 border border-white/50 shadow-xl rounded-full p-1.5 transition-all focus-within:bg-white focus-within:ring-4 ring-slate-900/5"
            >
              <input
                value={input}
              ...
              <motion.button 
                ...
                className="p-3.5 bg-slate-900 text-white rounded-full hover:bg-slate-800 transition-all shadow-xl disabled:opacity-10 flex items-center justify-center"
              >
                <Send size={20} />
              </motion.button>
            </form>
